...
from make_line_relay_templates_2 import make_line_relay_templates_2
from make_line_relay_templates_2 import std_filenames
...
def get_default_template():
    ...
    fn_pattern = 'Settings Dual Line Relay SEL-411L pri master Standard Rev *.docx'
